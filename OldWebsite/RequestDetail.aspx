<%@ Page Language="C#" MasterPageFile="~/RareCareTable.master" AutoEventWireup="true" CodeFile="RequestDetail.aspx.cs" Inherits="_Default" Title="Rare Care Request Detail" %>
...
Request Detail ASP.NET web page
...
<p style="color:Maroon">To log out, completely exit your browser when you are finished.  Because of the sensitive nature of this information, we ask that you not share the password or the contents of this website with anyone else.  Thank you!</p>
    ...
    <h3>EO Detail <asp:ImageButton ID="imgbtnRequestDetailHelp" runat="server" OnClientClick="window.open('helpRequestDetail.html','Rare Care Request Detail Help','width=300,height=300,left=300,top=300')" ImageUrl="~/iconQuestion.png" /></h3>
            ...
            <ItemTemplate>
                ...
                <asp:Label ID="GEN_DESCLabel" runat="server" Text='<%# Bind("GEN_DESC") %>'></asp:Label></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# String.Format("https://maps.google.com/?ll={0},{1}&z=13&t=h", Eval("Latitude"), Eval("Longitude")) %>' Target="_blank">Map</asp:HyperLink>
                            </td>
                        </tr>
                    </table>
                </div>
